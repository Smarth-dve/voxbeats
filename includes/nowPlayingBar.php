...
<script>
	...
	function setMute() {
		...
		var imageName = audioElement.audio.muted ? "volume-mute.png" : "vol.png";
		...
		<div id="nowPlayingCenter">
			...
			<div class="content playerControls">
				...
				<div class="buttons">
					...
					<button class="controlButton back" title="Back" onclick="prevSong()">
						<img src="assets/images/icons/prev.png" alt="Back">
					</button>
					...
					<button class="controlButton forward" title="Forward" onclick="nextSong()">
						<img src="assets/images/icons/next.png" alt="Forward">
					</button>
		...
		<div id="nowPlayingRight">
			...
			<div class="volumeBar">
				...
				<button class="controlButton volume" title="Mute" onclick="setMute()">
					<img src="assets/images/icons/vol.png" alt="Mute">
				</button>
